...
trait GpgKeys {
  ...
  val gpgExportSubKey = taskKey[File]("Exports a sub key pair without the primary secret key.")
  val gpgGenerateKey = taskKey[String]("Generates a new key pair.")
  val gpgHomeDir = settingKey[Option[File]]("The gpg home directory.")
  val gpgKeyFingerprint = settingKey[Option[String]]("The SHA-1 fingerprint of the key.")
  ...
  val gpgOutputFile = settingKey[File]("The output file.")
